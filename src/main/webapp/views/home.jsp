...
<head>
  ...
  <style>
    ...
    .section-title { font-weight:800; color:#1f2b3a; margin-bottom:1rem; }
    ...
    /* ---------- Chatbot Button (opens BotPenguin) ---------- */
    .chatbot-btn {
    ...
    .chatbot-btn:hover { transform: translateY(-3px); box-shadow: 0 14px 30px rgba(0,0,0,.32); }
    @media (max-width: 576px) { .chatbot-btn { right:16px; bottom:16px; } }
  </style>
</head>
<body>
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="complaintsMenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">Complaint</a>
          <ul class="dropdown-menu" aria-labelledby="complaintsMenu">
            <li><a class="dropdown-item" href="<%=ctx%>/views/Complaint.jsp"><i class="fas fa-plus me-2"></i>New Complaint</a></li>
            <li><a class="dropdown-item" href="<%=ctx%>/complaints/my"><i class="fas fa-list me-2"></i>My Complaints</a></li>
          </ul>
        </li>
      </ul>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        ...
        <a class="btn btn-light btn-lg me-2" href="<%=ctx%>/animals"><i class="fas fa-search me-2"></i>Browse Animals</a>
        <a class="btn btn-outline-light btn-lg me-2" href="<%=ctx%>/animals/new"><i class="fas fa-plus me-2"></i>List Your Animal</a>
        <!-- Optional full-page chatbot link -->
...
<!-- CHATBOT: Button that opens BotPenguin widget -->
...
<!-- BotPenguin Chatbot Widget (single include) -->
<script
  id="messenger-widget-b"
  src="https://cdn.botpenguin.com/website-bot.js"
  data-bot-id="68b86fc5313ee1e5c83b03b1,68b86f4df69639ff8ec220bd"
  defer>
</script>

<script>
  // Go to the chatbot page when clicked
